...
<div class="div-block-95 w-clearfix">
	...
	<div id="containergr" style="width:310px; height:112px;">
	<canvas id="c" width="310" height="107"></canvas>
	</div>
    </div>
    <div class="div-block-94">
		...
		<div id="containergr" style="width:310px; height:112px;">
           <canvas id="b" width="310" height="107"></canvas>
        </div>
    </div>
    <div class="div-block-94">
		...
		<div id="containergr" style="width:310px; height:112px;">
           <canvas id="a" width="310" height="107"></canvas>
        </div>
    </div>
	<div class="div-block-94" style="margin-right: 0px !important;">
