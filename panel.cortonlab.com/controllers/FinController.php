...
<div class="div-block-95 w-clearfix">
	...
	<div id="containergr" style="width:304px; height:102px;">
	<canvas id="c" width="312" height="104"></canvas>
	</div>
    </div>
    <div class="div-block-94">
		...
		<div id="containergr" style="width:304px; height:102px;">
           <canvas id="b" width="312" height="104"></canvas>
        </div>
    </div>
    <div class="div-block-94">
		...
		<div id="containergr" style="width:304px; height:102px;">
           <canvas id="a" width="312" height="104"></canvas>
        </div>
    </div>
	<div class="div-block-94" style="margin-right: 0px !important;">
