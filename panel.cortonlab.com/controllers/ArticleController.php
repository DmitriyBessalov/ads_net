    ...
    public static function actionIndex()
    {
        ...
        if ((strtotime($datebegin)<=strtotime($dateend)) AND (strtotime($datebegin)<=strtotime(date('d.m.Y')))) {
            ...
            foreach ($main_promo_id as $i) {
             ...
             <a style="color: #333333; outline: none; text-decoration: none;" href="/article-edit-content?id=' . $i['main_promo_id'] . '"><div class="text-block-103" style="margin-bottom: 15px; min-height: 44px;">' . $promo['title'] . '</div></a>
