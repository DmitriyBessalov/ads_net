    ...
    public static function actionIndex()
    {
        ...
        if ((strtotime($datebegin)<=strtotime($dateend)) AND (strtotime($datebegin)<=strtotime(date('d.m.Y')))) {
            ...
            foreach ($main_promo_id as $i) {
	         ...
	         <div style="background: linear-gradient(0deg, rgb(255, 255, 255), rgb(17, 109, 214, 0.0)); width: 298px; height: 80px; margin-left: -20px; margin-top: 66px; position: relative;"></div>
