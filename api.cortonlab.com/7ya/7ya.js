        ...
        corton_promos.innerHTML= ''+
            ...
            '<div id="corton_scroll_to_site">'+
                '<div id="corton_sticky_container">'+
                    ...
                    '<div id="corton_border_title"><div>Листая дальше вы перейдёте на: &nbsp;<a href="'+s2s[i][1]+'">'+host[2]+'</a></div><div style=" text-align: center; color: #c5c5c5; margin-bottom: 10px; font-size: 12px; ">Powered by Cortonlab</div></div>'+
