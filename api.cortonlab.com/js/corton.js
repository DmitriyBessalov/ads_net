...
if (corton_complete!=1) {
   ...
   //           console.log(result['istochnic']);
                if ((result['istochnic']!=='') && (innerWidth>1000)) {
                    ...
                    result['istochnic'] = result['istochnic'].replace(/'''/g, "&#39;");
                    ist='<p> </p>' +
                        '<p style="line-height: 1.3; color: #999; font-size: 12px;cursor: help;" title="'+result['istochnic']+'">Источники' +
                            '<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="22" height="22" viewBox="0 0 172 172" style=" fill:#000000;"><g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><path d="M0,172v-172h172v172z" fill="none"></path><g fill="#999999"><path d="M86,14.33333c-39.49552,0 -71.66667,32.17115 -71.66667,71.66667c0,39.49552 32.17115,71.66667 71.66667,71.66667c39.49552,0 71.66667,-32.17115 71.66667,-71.66667c0,-39.49552 -32.17115,-71.66667 -71.66667,-71.66667zM86,28.66667c31.74921,0 57.33333,25.58412 57.33333,57.33333c0,31.74921 -25.58412,57.33333 -57.33333,57.33333c-31.74921,0 -57.33333,-25.58412 -57.33333,-57.33333c0,-31.74921 25.58412,-57.33333 57.33333,-57.33333zM78.83333,50.16667v14.33333h14.33333v-14.33333zM78.83333,78.83333v43h14.33333v-43z"></path></g></g></svg>' +
                        '</p>';
                }
            ...
            if ((result['scroll2site']==1) && (scroll2site_activ==1))
            {
                ...
                '<style type="text/css">'+
                    ...
                    '#corton_border_title{background-color:#fff8d9;max-height:82px;height:82px;display: flex; padding: 0px 10px; justify-content: center; align-items: center;text-align: center} '+
    ...
    function corton_widget() {
        ...
        function onscr() {
            ...
            if (location.host=='eva.ru'||location.host=='teleprogramma.pro'||location.host=='www.kleo.ru') {
                ...
                if (max_recomend!==max_recomend_old){
                    show_recomend = 0;
                }

                if (max_natpre!==max_natpre_old ){
                    show_natpre = 0;
                }
            ...
            if (widget_natpre) {
                if (widget_natpre.getBoundingClientRect().top !== 0) {
                    if (widget_natpre.getBoundingClientRect().top - window.innerHeight - window.innerHeight/2 < 0) {
                        if(!widget_natpre.classList.contains('wait')) {
                            show_widget_aktiv = true;
                            show_natpre = 2;
                            widget_natpre.classList.add('wait');
                            widget_natpre.classList.add(max_natpre);
