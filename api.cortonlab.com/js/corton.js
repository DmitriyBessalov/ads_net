...
if (corton_complete!=1) {
    ...
    function corton_promo() {
        ...
        xhr.onreadystatechange = function() {
            ...
            if (marker_reklamiy==='1'){
                ...
                marker_reklamiy='<p></p><p></p><p></p><p></p><p></p>'+ist+'<div style="line-height: 1.3; color: #999; font-size: 12px !important; position: relative; top: 6px;">На правах рекламы</div>';
            }else{
                marker_reklamiy='';
            }
    ...
    function corton_widget() {
        ...
        if (!(recomend_algorithm_output!=='' || natpre_algorithm_output!=='')){
            setTimeout(corton_widget,250);
            return true;
        }
