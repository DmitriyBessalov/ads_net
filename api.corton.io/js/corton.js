...
function corton_promo() {
    ...
    xhr.onreadystatechange = function() {
        ...
        if (promo_selector_title.length!=0){
            ...
            widget_promo.innerHTML = result['text']+form+'<a style="float: right;" href="https://corton.io/" target="_blank"><img style="width:80px; height:20px;" src="https://corton.io/images/cortonlogo.png"></a>';
        }else{
            widget_promo.innerHTML = '<h1>'+result['title']+'</h1>'+result['text']+form+'<a style="float: right;" href="https://corton.io/" target="_blank"><img style="width:80px; height:20px;" src="https://corton.io/images/cortonlogo.png"></a>';
        }
